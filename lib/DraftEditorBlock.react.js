...
var DraftEditorBlock = function (_React$Component) {
  ...
  DraftEditorBlock.prototype.componentDidMount = function componentDidMount() {
    ...
    if (scrollParent === window) {
      ...
      !(blockNode instanceof blockNode.ownerDocument.defaultView.HTMLElement) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'blockNode is not an HTMLElement') : invariant(false) : void 0;
